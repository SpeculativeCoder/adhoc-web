 ...
 * @author <a href="https://github.com/SpeculativeCoder">SpeculativeCoder</a> (modified {@link AdhocLogbackColorConverter})
 */
public class AdhocLogbackColorConverter extends CompositeConverter<ILoggingEvent> {
